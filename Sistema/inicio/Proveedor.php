            ...
            <div class="formulario">
              <form>
                <div class="form-group">
                  ...
                  <input id="nombre" type="text" class="form-control" aria-describedby="emailHelp" placeholder="Nombre del Proveedor">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input id="estado" type="text" class="form-control" aria-describedby="emailHelp" placeholder="Estado">
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">RUC</label>
                  <input id="ruc" type="text" class="form-control" aria-describedby="emailHelp" placeholder="RUC">
                </div>
              ...
              <div class="modal-body">
                <form role="form">
                  <div class="form-group">
                    ...
                    <label for="exampleInputEmail1">Nombre</label>
                    <input id="nombreM" type="text" class="form-control" aria-describedby="emailHelp" placeholder="Nombre del Proveedor">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Direccion</label>
                  ...
                  <div class="form-group">
                    <label for="exampleInputEmail1M">Estado</label>
                    <input id="estadoM" type="text" class="form-control" aria-describedby="emailHelp" placeholder="Estado">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">RUC</label>
                    <input id="rucM" type="text" class="form-control" aria-describedby="emailHelp" placeholder="RUC">
                  </div>
                </form>
              </div>
